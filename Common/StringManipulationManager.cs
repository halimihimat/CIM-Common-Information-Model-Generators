...
namespace Common
{
    ...
    public class StringManipulationManager
    {
        ...
        public static string GetSystemType(string type)
        {
            switch (type)
            {
                case "int":
        ...
        public static string GetMaxCardinality(string card)
        {
            switch (card)
            {
                case "1":
        ...
        public static string GetAsMethod(string type)
        {
